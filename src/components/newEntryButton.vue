<template>
   <div class="buttons">
      ...
      <button class="buttons__secondary buttons__secondary--1">
      ...
      <button class="buttons__secondary buttons__secondary--2">
      ...
      <button class="buttons__secondary buttons__secondary--3">
         <svg class="buttons__icon" viewBox="0 0 16 16">
            <path
